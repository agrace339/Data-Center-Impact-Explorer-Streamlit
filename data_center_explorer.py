...
st.write("In order to understand the health and wellness of a state, we utilized data from the United Health "
         ...
         "available for charitable use. A ranking of 1 means the state (and, by extension, its residents) exhibits healthier "
         "behaviors, socioeconomic conditions, physical environments, clinical care quality, and health outcomes "
         "as related to a particular condition when compared to other states. As quality in these areas decreases, "
         "so too does the ranking associated with the state. To visually demonstrate how preexisting health conditions may interact "
         ...
         "rankings you see below. **Select a state to see how it currently ranks on average across these three metrics:**")
...
st.write("Although we're looking at rather generalized versions of these three conditions, the health burden "
         ...
         "Black Americans are also disproportionately affected by the health impacts of data centers, "
