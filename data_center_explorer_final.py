...
show_plot(
    "drought_1.png",
    "Source:  U.S. Drought Monitor (2026).",
)
...
st.markdown(
    ...
    'prolonged exposure (Pavlinch, 2026)</p>',
    unsafe_allow_html=True,
)
...
st.write("In order to understand the health and wellness of a state, we utilized data from the United Health "
         ...
         "(FracTracker, 2026) was also used."
         "Using emerging literature as a guideline (Pavlinch, 2026; Han et al., 2026), we selected three diagnoses "
...
measure_df = avghealth[avghealth["Measure"] == selected_measure]
...
st.write("Here, we examine the connections between data center presence and political factors at the county "
         "level based on data from the FracTracker Alliance U.S. Data Centers Tracker(FracTracker, 2026) "
         "and the National Neighborhood Data Archive (ICPSR 38506) (Clary et al., 2024); "
         "for geographic code matching to make this analysis possible, we used RowZero FIPS code lists "
         "and location mapping (RowZero, 2025). NANDA provides information about voter registration, turnout, and "
...
with col1:
    st.image("political_histogram_1.png", caption="Registered voters per county by data center presence (with/without). Source: National Neighborhood Data Archive, FracTracker", use_container_width=True)

with col2:
    st.image("political_histogram_2.png", caption="Registered voters per county by number of data centers (1-6+). Source: National Neighborhood Data Archive, FracTracker", use_container_width=True)
...
st.markdown(
    ...
    "NBC Washington."
    "- Pavlinich, E. J. (2026). The Dangers of Data Centers. [*Environmental Health Project.*]"
    "(https://www.environmentalhealthproject.org/post/the-dangers-of-data-centers)"
    "- Han, Y., Wu, Z., Li, P., Wierman, A., & Ren, S. (2024). Health-Informed Computing: "
    "[*Estimating and Addressing the Public Health Impact of Data Centers*](https://arxiv.org/abs/2412.06288)"
    "- Mahoney, A. (2025). [*How the data center boom could harm Black communities.*]"
    "(https://www.canarymedia.com/articles/fossil-fuels/how-the-data-center-boom-could-harm-black-communities)"
    "- National Conference of State Legislatures. (2026). [*Which States are Banning Data Centers?*]"
    "https://www.ncsl.org/fiscal/which-states-are-banning-data-centers.\n"
    "- United Health Foundation (2025). America's Health Rankings 2025 annual report [*Dataset.*]"
    "(https://www.americashealthrankings.org/publications/reports/2025-annual-report)"
    "- Row Zero. (2025, March 6). FIPS codes for all U.S. locations in a spreadsheet [*Data set.*]"
    "(https://rowzero.com/datasets/fips-codes-lookup#zip-code-mappings)"
    " - Clary, W., Gomez-Lopez, I. N., Chenoweth, M., Gypin, L., Clarke, P., Noppert, G., Li, M., "
    "& Kollman, K. (2024). National Neighborhood Data Archive (NaNDA): Voter Registration, Turnout, and "
    "Partisanship by County, United States, 2004-2022 [*Data set.*](https://www.icpsr.umich.edu/web/ICPSR/studies/38506/versions/V2) "
    "Inter-university Consortium for Political and Social Research." 
    "- Hedge, G. (2026). [*Myths vs. Reality: Data Centers and Water Usage.*](https://www.fwpcoa.org/content.aspx?page_id=5&club_id=859275&item_id=130961)"
